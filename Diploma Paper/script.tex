...
\begin{document} 
	...
	% Титульный лист
	\input{./source_tex/title_page.tex}
	\newpage
	...
	\input{./source_tex/introduction.tex}
	\input{./source_tex/pre_experiment.tex}
	\input{./source_tex/experiment.tex}
	\input{./source_tex/discussion.tex}
	\input{./source_tex/outroduction.tex}
